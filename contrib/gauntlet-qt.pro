...
RESOURCES += src/qt/gauntlet.qrc src/qt/gauntlet_locale.qrc

TRANSLATIONS += src/qt/locale/gauntlet_bg.ts \
                src/qt/locale/gauntlet_de.ts \
                src/qt/locale/gauntlet_en.ts \
                src/qt/locale/gauntlet_es.ts \
                src/qt/locale/gauntlet_fi.ts \
                src/qt/locale/gauntlet_fr.ts \
                src/qt/locale/gauntlet_it.ts \
                src/qt/locale/gauntlet_ja.ts \
                src/qt/locale/gauntlet_pl.ts \
                src/qt/locale/gauntlet_pt.ts \
                src/qt/locale/gauntlet_ru.ts \
                src/qt/locale/gauntlet_sk.ts \
                src/qt/locale/gauntlet_sv.ts \
                src/qt/locale/gauntlet_vi.ts \
                src/qt/locale/gauntlet_zh_CN.ts \
                src/qt/locale/gauntlet_zh_TW.ts
