Contributing to Gauntlet Core
============================

The Gauntlet Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/gauntlet-project/gauntlet/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Gauntlet Core project, and is not to be
confused with overall Gauntlet Network Protocol consensus changes.

Whether a pull request is merged into Gauntlet Core rests with the project merge
...
Patches that change Gauntlet consensus rules are considerably more involved than
...
Where a patchset proposes to change the Gauntlet consensus, it must have been
...
The project leader is the release manager for each Gauntlet Core release.
