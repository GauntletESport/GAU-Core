...
from fake_stake.base_test import Gauntlet_FakeStakeTest

class zGAUValidCoinSpendTest(Gauntlet_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zGAUs..." % DENOM_TO_USE)
