...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::GAU);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeGauntletAmount"))
        SoftSetArg("-anonymizegauntletamount", settings.value("nAnonymizeGauntletAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in gauntlet.cpp during shotdown to also remove the window positions
