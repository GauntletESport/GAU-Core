                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzGAUPathCustom = GetArg("-zgaubackuppath", "");
    ...
    if(!strzGAUPathCustom.empty()) {
        ui->wallet_customzgaubackuppath->setText(QString::fromStdString(strzGAUPathCustom));
        ui->wallet_customzgaubackuppath_label->setVisible(true);
        ui->wallet_customzgaubackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzGAUPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Gauntlet RPC console.") + "<br>" +
