...
/* Gauntlet GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Gauntlet"
#define QAPP_ORG_DOMAIN "gauntlet.org"
#define QAPP_APP_NAME_DEFAULT "Gauntlet-Qt"
#define QAPP_APP_NAME_TESTNET "Gauntlet-Qt-testnet"
