...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Gauntlet Core"),
     ...
     * override -datadir in the gauntlet.conf file in the default data directory
     * (to be consistent with gauntletd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
