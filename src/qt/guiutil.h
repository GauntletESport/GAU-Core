...
/** Utility functions used by the Gauntlet Qt UI.
 */
namespace GUIUtil
{
...
// Render Gauntlet addresses in monospace font
...
// Parse "gauntlet:" URI into recipient object, return true on successful parsing
