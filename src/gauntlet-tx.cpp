...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Gauntlet Core gauntlet-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gauntlet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gauntlet transaction") + "\n" +
                               "  gauntlet-tx [options] -create [commands]   " + _("Create hex-encoded gauntlet transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gauntlet transaction
