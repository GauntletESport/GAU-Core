...
#ifndef Gauntlet_ZGAUWALLET_H
#define Gauntlet_ZGAUWALLET_H
...
public:
    CzGAUWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZGAU(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZGAU(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
