...
#ifndef Gauntlet_ZGAUTRACKER_H
#define Gauntlet_ZGAUTRACKER_H
...
public:
    CzGAUTracker(std::string strWalletFile);
    ~CzGAUTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzGAUWallet* zGAUWallet = NULL);
