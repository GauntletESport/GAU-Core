...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Gauntlet server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Gauntlet server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Gauntlet features */
        {"gauntlet", "listmasternodes", &listmasternodes, true, true, false},
        {"gauntlet", "getmasternodecount", &getmasternodecount, true, true, false},
        {"gauntlet", "masternodeconnect", &masternodeconnect, true, true, false},
        {"gauntlet", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"gauntlet", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"gauntlet", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"gauntlet", "masternodecurrent", &masternodecurrent, true, true, false},
        {"gauntlet", "masternodedebug", &masternodedebug, true, true, false},
        {"gauntlet", "startmasternode", &startmasternode, true, true, false},
        {"gauntlet", "createmasternodekey", &createmasternodekey, true, true, false},
        {"gauntlet", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"gauntlet", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"gauntlet", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"gauntlet", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"gauntlet", "getmasternodescores", &getmasternodescores, true, true, false},
        {"gauntlet", "preparebudget", &preparebudget, true, true, false},
        {"gauntlet", "submitbudget", &submitbudget, true, true, false},
        {"gauntlet", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"gauntlet", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"gauntlet", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"gauntlet", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"gauntlet", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"gauntlet", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"gauntlet", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"gauntlet", "checkbudgets", &checkbudgets, true, true, false},
        {"gauntlet", "mnsync", &mnsync, true, true, false},
        {"gauntlet", "spork", &spork, true, true, false},
        {"gauntlet", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzgauseed", &getzgauseed, false, false, true},
        {"zerocoin", "setzgauseed", &setzgauseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzgau", &searchdzgau, false, false, true},
        {"zerocoin", "dzgaustate", &dzgaustate, false, false, true},
...
{
    return "> gauntlet-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21335/\n";
}
